...
class Service
{
    ...
    /**
     * @var Collection<int, ServiceFeature>
     */
    #[ORM\OneToMany(targetEntity: ServiceFeature::class, mappedBy: 'service')]
    ...
    public function addServiceFeature(ServiceFeature $serviceFeature): static
    {
        if (!$this->serviceFeature->contains($serviceFeature)) {
            $this->serviceFeature->add($serviceFeature);
    ...
    public function removeServiceFeature(ServiceFeature $serviceFeature): static
    {
